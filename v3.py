...
def get_trading_session():
    """Return session name and color based on UTC+1 time"""
...
def send_telegram(message: str):
    """Send Telegram alert using dummy credentials"""
